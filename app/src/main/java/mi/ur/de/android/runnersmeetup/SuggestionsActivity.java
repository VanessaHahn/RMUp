...
public class SuggestionsActivity extends AppCompatActivity {
    ...
    private void searchForUser() {
        ...
        try {
            ...
            if(dbString.indexOf("/")>0){
                ...
                final ArrayAdapter<String> listenadapter = new ArrayAdapter<String>(SuggestionsActivity.this,android.R.layout.simple_list_item_1, string);
    ...
    public void startProfil(String name){
        Intent profilIntent = new Intent(SuggestionsActivity.this, ProfileActivity.class);
